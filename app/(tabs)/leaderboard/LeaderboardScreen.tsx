          ...
          {currentUser && (
            <>
              <div className="my-4 flex items-center gap-2">
                ...
                <p className="text-[9px] font-black uppercase tracking-[1.8px] text-[var(--lb-meta-color)]">
                  YOUR POSITION
                </p>
                <div className="h-px flex-1 bg-[var(--lb-divider)]" />
              </div>
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center justify-between gap-2">
            <div className="min-w-0">
              <p className="truncate text-[16px] font-bold leading-[1.2] tracking-[-0.4px] text-[var(--lb-name-color)]">
                {leader.name}
              </p>
              <p className="truncate text-[10px] font-black uppercase tracking-[1px] text-[var(--lb-role-color)]">
                {leader.title}
              </p>
            </div>
            <div className="rounded-full bg-[var(--lb-score-bg)] px-2 py-1 text-[10px] font-bold text-[var(--lb-score-color)]">
              {leader.points}D
            </div>
          </div>
          <p className="mt-1 text-[10px] font-bold text-[var(--lb-solved-color)]">
            #{leader.rank} • {leader.solved} solved
          </p>
        </div>
      </div>
    </article>
...
function SegmentButton({
  ...
  return (
    <button
      ...
      type="button"
      className={cn(
        'relative whitespace-nowrap rounded-[999px] text-[10px] font-black uppercase tracking-[1px]',
        active
          ? 'text-[var(--lb-tab-active-color)]'
    ...
    >
      {active ? (
        <motion.span
          ...
          className="absolute inset-0 rounded-[999px] bg-[var(--lb-tab-active-bg)] shadow-[var(--lb-tab-active-shadow)]"
        />
      ) : null}
