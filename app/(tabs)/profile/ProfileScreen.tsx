  ...
  return (
    <MobileScreen>
      <section className="mx-auto flex w-full max-w-[361px] flex-col gap-4">
        ...
        <section className="rounded-[16px] border border-[#bedbff] bg-[#dbeafe] p-3 shadow-[0px_25px_50px_-12px_#1c398e]">
          <div className="flex flex-col items-center">
            ...
            <p className="mt-1 text-[10px] font-black uppercase tracking-[1px] text-[#3b82f6]">PRODUCT GYM MEMBER</p>
          </div>
        ...
        <section className="rounded-[16px] bg-[linear-gradient(180deg,#1d4ed8_0%,#1e3a8a_100%)] p-3 text-white shadow-[0px_25px_50px_-12px_#1c398e]">
...
function StatCard({ label, value }: { label: string; value: string }) {
  return (
    <article className="rounded-[12px] bg-white px-2 py-2 text-center">
      <p className="text-[7px] font-black uppercase tracking-[0.7px] text-[#90a1b9]">{label}</p>
      <p className="mt-1 text-[12px] font-black text-[#0f172b]">{value}</p>
    </article>
  );
}
